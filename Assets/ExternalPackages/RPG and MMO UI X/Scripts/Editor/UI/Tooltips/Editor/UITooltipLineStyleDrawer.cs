    ...
    class UITooltipLineStyleDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (property.isExpanded)
            {
                ...
                EditorGUI.PropertyField(position, property.FindPropertyRelative("OverrideTextMaterial"), new GUIContent("Override Text Material"));
                position = new Rect(position.x, position.y + EditorGUIUtility.singleLineHeight + Spacing, position.width, EditorGUIUtility.singleLineHeight);
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            return base.GetPropertyHeight(property, label) + 20f + (EditorGUIUtility.singleLineHeight * 7f) + (Spacing * 6f) + effectsHeight;
        }
    }
}
