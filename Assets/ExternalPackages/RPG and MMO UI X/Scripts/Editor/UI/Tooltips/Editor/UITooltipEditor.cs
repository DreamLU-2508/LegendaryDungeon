...
namespace DuloGamesEditor.UI
{
	...
	public class UITooltipEditor : Editor {
		...
		private SerializedProperty m_HeightChildSize;
        ...
        protected virtual void OnEnable()
		{
			...
			this.m_HeightChildSize = this.serializedObject.FindProperty("m_HeightChildSize");
		...
		protected void DrawGeneralProperties()
		{
			...
			EditorGUILayout.PropertyField(this.m_HeightChildSize, new GUIContent("Child Height"));
