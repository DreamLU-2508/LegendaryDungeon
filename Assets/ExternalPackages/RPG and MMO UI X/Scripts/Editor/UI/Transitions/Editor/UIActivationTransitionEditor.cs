...
{
	[CanEditMultipleObjects, CustomEditor(typeof(UIActivationTransition))]
	public class UIActivationTransitionEditor : Editor
	{
		...
		public override void OnInspectorGUI()
		{
			...
			UIActivationTransition.Transition transition = (UIActivationTransition.Transition)this.m_TransitionProperty.enumValueIndex;
			...
			if (transition == UIActivationTransition.Transition.ColorTint || transition == UIActivationTransition.Transition.SpriteSwap || transition == UIActivationTransition.Transition.TextColor)
			{
				EditorGUILayout.PropertyField(this.m_TargetGraphicProperty, new GUIContent("Target Graphic"));

				if (transition == UIActivationTransition.Transition.ColorTint)
				{
					if (graphic == null)
					{
				...
				else if (transition == UIActivationTransition.Transition.TextColor)
				{
				...
				else if (transition == UIActivationTransition.Transition.SpriteSwap)
				{
			...
			else if (transition == UIActivationTransition.Transition.Animation)
			{
			...
			else if (transition == UIActivationTransition.Transition.CanvasGroup)
			{
