...
{
    [ExecuteInEditMode, AddComponentMenu("UI/Activation Transition")]
    public class UIActivationTransition : MonoBehaviour
    {
...
#pragma warning restore 0649
        ...
        protected UIActivationTransition()
        {
        ...
        protected void OnEnable()
        {
            ...
            DoStateTransition(VisualState.Active, false);
        }
        ...
        protected virtual void DoStateTransition(VisualState state, bool instant)
        {
            ...
            switch (state)
            {
                ...
                case VisualState.Active:
                    ...
                    triggername = this.m_ActiveTrigger;
                    break;
            }
